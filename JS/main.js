...
function scrollReava() {
  ...
  ScrollReveal().reveal('.section', {opacity: 0.5});
  ScrollReveal().reveal('.blocPhone', {mobile: false, origin: 'top', duration: 1000, distance: '200px', scale: 0.85,});
  ScrollReveal().reveal('.sectionBlacBar img', {scale: 0.85, duration: 3000});
}
scrollReava();
